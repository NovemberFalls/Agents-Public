---
template: atlas-review
version: 1
---

# Atlas Review — [SPECIALIST] / Tier [N]
**Reviewer:** Atlas
**Date:** [YYYY-MM-DD]
**Project:** [project]
**Specialist report reviewed:** [specialist name, task identifier]
...
Specific check:
- [integration requirement from brief] → [what specialist said] → [Atlas's verification: match/mismatch]
...
## 5. Security Flags (for non-Zara specialists)

**Result:** NONE | FLAG

[Any new user-controlled input entering an unsafe context? New public endpoint without auth? Secret logged? This is not a full security review — flag obvious issues for Zara's awareness.]
...
[Did the specialist produce a "What Sam should test" section? Are the specified tests specific enough to actually catch a regression? Are negative cases specified?]
...
## Atlas Notes for Nadia (if escalating)

*(Only populated if iteration limit reached without resolution)*

**Impasse description:** [what was asked, what was delivered, why Atlas can't approve, what decision is needed from Nadia]
